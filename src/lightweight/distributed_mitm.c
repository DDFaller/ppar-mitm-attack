 ...
 *
 * Implementation of the MitM distributed algorithm.
 *
...
#define BUFFER_RELATIVE_SIZE    0.05
...
int golden_claw_search(int maxres, u64 k1[], u64 k2[])
{
    ...
    u64 x_start = N_local * rank;
    u64 x_end = x_start + N_local;
...
int main(int argc, char **argv)
{
    ...
    dict_size = ceil(1.125 * (1ull << n) / num_processes);
